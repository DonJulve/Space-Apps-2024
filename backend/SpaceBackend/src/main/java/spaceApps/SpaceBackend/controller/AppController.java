...
public class AppController {
        ...
        private List<AllPlanetData> retrieveDataFromDB(PlanetDataRequest request) throws Exception{
            ...
            */
            ...
            ResponseEntity<AllPlanetData[]> apiResponse = restTemplate.getForEntity(apiREAL, AllPlanetData[].class);    
            if (apiResponse.getStatusCode().value() == 200) {
                List<AllPlanetData> allPlanets = List.of(apiResponse.getBody());
